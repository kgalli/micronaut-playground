 ...
 */
package bookshop.jooq.tables;


import bookshop.jooq.Public;
import bookshop.jooq.tables.records.BooksRecord;
...
public class Books extends TableImpl<BooksRecord> {
    ...
    private static final long serialVersionUID = 1323424886;
     ...
     */
    public final TableField<BooksRecord, String> TITLE = createField("title", org.jooq.impl.SQLDataType.VARCHAR(50), this, "");

    /**
     * The column <code>public.books.author</code>.
     */
    public final TableField<BooksRecord, String> AUTHOR = createField("author", org.jooq.impl.SQLDataType.VARCHAR(50), this, "");
